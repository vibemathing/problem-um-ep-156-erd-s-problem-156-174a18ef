...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-156-erd-s-problem-156-174a18ef-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-156"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-156-erd-s-problem-156-174a18ef-v1",
      "problem_contract_sha256": "968a8588562144156cdf9dd0577f2be48bfcc24b4813abbc960543d8cd703c12",
      "problem_id": "problem:um-ep-156-erd-s-problem-156-174a18ef",
      "route_id": "route:um-ep-156-erd-s-problem-156-174a18ef-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-156-erd-s-problem-156-174a18ef-source-fidelity-01",
      "graph_id": "graph:um-ep-156-erd-s-problem-156-174a18ef-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-156-erd-s-problem-156-174a18ef-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-156-erd-s-problem-156-174a18ef-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist a maximal Sidon set $A\\subset \\{1,\\ldots,N\\}$ of size $O(N^{1/3})$?"
          },
          "statement_sha256": "26763f6f5463dc294f849ee424ff9a53bdad8fb92e551e896e5f8887d71079e7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-156-erd-s-problem-156-174a18ef-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-156-erd-s-problem-156-174a18ef-root",
      "route_id": "route:um-ep-156-erd-s-problem-156-174a18ef-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-156-284ff9e562d7",
        "url": "https://www.unsolvedmath.com/problems/EP-156"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
